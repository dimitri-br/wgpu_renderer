...
impl Transform{
    ...
    pub fn set_transform(&mut self, translation: glam::Vec3, rotation: glam::Quat, scale: glam::Vec3){
    ...
    pub fn transform(&mut self, translation: glam::Vec3, rotation: glam::Quat, scale: glam::Vec3){
        self.matrix = self.matrix * glam::Mat4::from_scale_rotation_translation(scale, rotation, translation);
    }
